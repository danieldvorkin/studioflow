...
import { studioSettingsMock, classTemplatesMock, instructorsMock, currentUserMock } from '../helpers/apolloMocks'
...
describe('Moderator role navigation', () => {
  ...
  it('shows platform owner picker on /owner (not regular owner dashboard)', async () => {
    ...
    const mod = moderatorUser({ id: 'mod-1', name: 'Maxine Moderator', email: 'max@example.com' })
    ...
    expect(await screen.findByRole('heading', { name: 'Godmode' })).toBeInTheDocument()
  })
})
