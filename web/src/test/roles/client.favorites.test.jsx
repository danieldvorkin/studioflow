...
import Sessions from "../../pages/owner/classes/Sessions.jsx";
...
describe("Client favorites", () => {
  ...
  it("can favorite a session and see it in Favorites", async () => {
    ...
    const favoritesEmptyMock = {
      request: {
        query: MY_FAVORITE_CLASS_SESSIONS,
        variables: { studioId: "studio-1" },
      },
    ...
    const sessionsMock = {
      request: {
        ...
        variables: { from: null, to: null, studioId: "studio-1" },
      },
    ...
    const toggleMock = {
      request: {
        query: TOGGLE_FAVORITE_CLASS_SESSION,
        variables: { classSessionId: "sess-1" },
      },
      result: {
        data: {
          toggleFavoriteClassSession: {
            __typename: "ToggleFavoriteClassSessionPayload",
            favorited: true,
            classSession: { __typename: "ClassSession", id: "sess-1" },
            errors: [],
          },
        },
      },
