  ...
  if (!isOwner) {
    return (
      <div className="mx-auto max-w-xl rounded-2xl border border-slate-800 bg-slate-900/80 p-6 text-sm text-slate-200">
        ...
        <p className="text-sm text-slate-400">Only the studio owner can manage instructor payouts.</p>
      </div>
    )
  }
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6">
      <header className="flex flex-col gap-1">
        <h1 className="text-2xl font-semibold tracking-tight text-slate-50">Instructor payouts</h1>
        <p className="text-sm text-slate-400">Review weekly earnings, manage compensation rules, and pay out via Stripe Connect.</p>
      </header>
