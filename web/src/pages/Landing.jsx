    ...
    <div className="min-h-screen bg-canvas">
      <div className="relative">
        ...
        <header className="sticky top-0 z-30 mx-auto flex w-full max-w-6xl items-center justify-between border-b border-slate-800 bg-slate-950/70 px-4 py-4 backdrop-blur">
          <Link
            to="/"
            className="text-xs font-semibold tracking-[0.3em] uppercase text-sky-400/80"
          >
        ...
        <main className="relative mx-auto w-full max-w-6xl px-4 pb-16 pt-10 md:pt-14">
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-4 max-w-xl text-sm text-slate-300">
                StudioFlow helps studios sell more sessions with less admin:
                fast booking, clear calendars, client-friendly checkouts, and
                owner-grade reporting — without the chaos.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/60 p-6">
                <div className="flex items-center justify-between">
                  <div className="text-sm font-semibold uppercase tracking-[0.22em] text-sky-400">
                    Live studio view
                  </div>
                ...
                <div className="mt-5 grid gap-3">
                      ...
                      <div className="flex items-center justify-between rounded-xl border border-slate-800 bg-slate-900/60 px-3 py-2">
                        <div className="min-w-0">
                          ...
                          <div className="text-[11px] text-slate-400">
                            6/8 booked • waitlist enabled
                          </div>
                        </div>
                        <div className="rounded-full bg-sky-500/20 px-2 py-1 text-[11px] font-semibold text-sky-200">
                          Open
                        </div>
                      </div>
                      <div className="flex items-center justify-between rounded-xl border border-slate-800 bg-slate-900/60 px-3 py-2">
                        <div className="min-w-0">
                          ...
                          <div className="text-[11px] text-slate-400">
                            8/8 booked • cards on file
                          </div>
                        </div>
                        <div className="rounded-full bg-emerald-500/20 px-2 py-1 text-[11px] font-semibold text-emerald-200">
                          Full
                        </div>
                      </div>
                      <div className="flex items-center justify-between rounded-xl border border-slate-800 bg-slate-900/60 px-3 py-2">
                        <div className="min-w-0">
                          ...
                          <div className="text-[11px] text-slate-400">
                            1/1 booked • payout tracked
                          </div>
                        </div>
                        <div className="rounded-full bg-fuchsia-500/20 px-2 py-1 text-[11px] font-semibold text-fuchsia-200">
                          Booked
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <div className="rounded-2xl border border-slate-800 bg-slate-950/30 p-4">
                      ...
                      <div className="mt-2 text-sm text-slate-200">
                        Instructor splits you can trust
                      </div>
                      <div className="mt-3 flex items-center gap-2 text-[11px] text-slate-400">
                        <span className="inline-flex h-1.5 w-1.5 rounded-full bg-emerald-400" />
            ...
            <div className="flex items-end justify-between gap-6">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-slate-300">
                  Built for studios that care about client experience and
                  operational clarity.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm text-slate-300">
                  Quickly see capacity, attendance, and what’s coming next.
                </div>
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm text-slate-300">
                  Clients book from the schedule and keep payment methods ready.
                </div>
                <div className="mt-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                  Less admin
                </div>
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm text-slate-300">
                  Track transactions and instructor payouts without
                  spreadsheets.
                </div>
                <div className="mt-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                  Get paid
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm text-slate-300">
                  Run multiple locations with consistent templates and
                  operations.
                </div>
                <div className="mt-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                  Scale confidently
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm text-slate-300">
                  Owners, staff, instructors, and clients each get the right
                  tools.
                </div>
                <div className="mt-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                  Right views
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm text-slate-300">
                  Clean navigation and focused pages so your team moves fast.
                </div>
                <div className="mt-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                  No clutter
                </div>
          ...
          <section id="roles" className="mt-16 scroll-mt-24">
            ...
            <h2 className="mt-2 text-2xl font-semibold text-slate-50">
              Built for owners, staff, instructors, and clients.
            </h2>
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm font-semibold text-slate-100">
                  Know what’s happening — and what’s paying.
                </div>
                <ul className="mt-3 space-y-2 text-sm text-slate-300">
                  <li className="flex gap-2">
                    <span className="text-emerald-400">✓</span>
                    <span>Locations, templates, and policies in one place</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-emerald-400">✓</span>
                    <span>Bookings visibility across the calendar</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-emerald-400">✓</span>
                    <span>Instructor payouts with fewer disputes</span>
                  </li>
                </ul>
              </div>
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                <div className="text-[11px] font-semibold uppercase tracking-[0.22em] text-fuchsia-300">
                  Staff & instructors
                </div>
                <div className="mt-2 text-sm font-semibold text-slate-100">
                  Stay in flow during busy hours.
                </div>
                <ul className="mt-3 space-y-2 text-sm text-slate-300">
                  <li className="flex gap-2">
                    <span className="text-emerald-400">✓</span>
                    <span>Quickly find sessions and bookings</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-emerald-400">✓</span>
                    <span>See client details and status at a glance</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-emerald-400">✓</span>
                    <span>Fewer tabs, fewer mistakes</span>
                  </li>
                </ul>
              </div>
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm font-semibold text-slate-100">
                  Book, pay, and come in relaxed.
                </div>
                <ul className="mt-3 space-y-2 text-sm text-slate-300">
                  <li className="flex gap-2">
                    <span className="text-emerald-400">✓</span>
                    <span>Easy schedule browsing</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-emerald-400">✓</span>
                  ...
                  <li className="flex gap-2">
                    <span className="text-emerald-400">✓</span>
                    <span>Favorites for faster re-booking</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section id="faq" className="mt-16 scroll-mt-24">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm text-slate-300">
                  No — this page is public. When you’re ready, create an owner
                  or client account.
                </div>
              </div>
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                <div className="text-sm font-semibold text-slate-100">
                  Can clients book and store cards?
                </div>
                <div className="mt-2 text-sm text-slate-300">
                  Yes. Clients can book from the schedule and manage saved
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm text-slate-300">
                  Yes — locations can be managed and selected directly in the
                  dashboard.
                </div>
              </div>
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 text-sm text-slate-300">
                  If you run a studio, start with an owner account. If you
                  attend classes, start as a client.
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="rounded-3xl border border-slate-800 bg-gradient-to-br from-slate-900/70 via-slate-900/60 to-slate-950/60 p-7 md:p-10">
              <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
                <div>
                  ...
                  <h2 className="mt-2 text-2xl font-semibold text-slate-50">
                    Turn scheduling into sales — not stress.
                  </h2>
                  <p className="mt-2 max-w-2xl text-sm text-slate-300">
                    Create an account and start organizing sessions, bookings,
                    and payments in minutes.
                  </p>
                </div>
          ...
          <footer className="mt-14 flex flex-col gap-4 border-t border-slate-800 py-8 text-xs text-slate-500 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="#roles" className="hover:text-slate-300">
                For teams
              </a>
