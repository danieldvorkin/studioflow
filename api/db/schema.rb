...
ActiveRecord::Schema[8.1].define(version: 2026_03_09_025644) do
  ...
  create_table "studio_pages", force: :cascade do |t|
    t.text "content"
    t.datetime "created_at", null: false
    t.integer "position", default: 0, null: false
    ...
    t.string "title", null: false
    t.datetime "updated_at", null: false
    t.index ["studio_id", "slug"], name: "index_studio_pages_on_studio_id_and_slug", unique: true
    t.index ["studio_id"], name: "index_studio_pages_on_studio_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    t.boolean "active", default: true, null: false
    t.boolean "also_instructor", default: false, null: false
